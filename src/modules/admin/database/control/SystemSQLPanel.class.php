...
class SystemSQLPanel extends TPage
{
    ...
    public function __construct()
    {
        ...
        $btn = $this->form->addAction( _t('Generate'), new Action(route('/admin/system/sql/panel/generate'), 'POST'), 'fa:check-circle');
        $btn->class = 'btn btn-sm btn-primary';
        
        $this->form->addAction( 'CSV', new Action(route('/admin/system/sql/panel/export/csv'), 'POST'), 'fa:table');
        ...
        $database->setChangeAction(new Action(route('/admin/system/sql/panel/database/change'), 'POST'));
        $table->setChangeAction(new Action(route('/admin/system/sql/panel/table/change'), 'POST'));
        ...
        $this->container->add(new TXMLBreadCrumb('menu.xml', '/admin/system/program'));
