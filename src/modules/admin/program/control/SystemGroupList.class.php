...
class SystemGroupList extends TStandardList
{
    ...
    public function __construct(Request $request)
    {
        ...
        $request->add(['route_base' => urlRoute('/admin/system/group')]);
        ...
        $btn = $this->form->addAction(_t('Find'), new Action(route('/admin/system/group/search'), 'POST'), 'fa:search');
        $btn->class = 'btn btn-sm btn-primary';
        $this->form->addActionLink(_t('New'), new Action(urlRoute('/admin/system/group/form')), 'bs:plus-sign green');
        ...
        $order_id = new Action(urlRoute('/admin/system/group/reload'));
        $order_id->setParameter('order', 'id');
        $column_id->setAction($order_id);
        
        $order_name = new Action(urlRoute('/admin/system/group/reload'));
        $order_name->setParameter('order', 'name');
        $column_name->setAction($order_name);
        
        // create EDIT action
        $action_edit = new TDataGridAction(urlRoute('/admin/system/group/edit'));
        ...
        $action_del = new TDataGridAction(urlRoute('/admin/system/group/delete'));
        ...
        $this->pageNavigation->setAction(new Action(urlRoute('/admin/system/group')));
        ...
        $container->add(new TXMLBreadCrumb('menu.xml', '/admin/system/group'));
    ...
    {
        $this->route = urlRoute('/admin/system/group');
    }
}
