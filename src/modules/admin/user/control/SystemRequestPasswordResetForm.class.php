...
use Adianti\Base\Modules\Admin\User\Exception;
...
class SystemRequestPasswordResetForm extends TPage
{
    ...
    function __construct($param)
    {
        ...
        $btn = $this->form->addAction(_t('Send'), new Action(route('/password/request/reset'), 'POST'), '');
        ...
        try
        {
            ...
            if ($user instanceof SystemUser)
            {
                ...
                else
                {
                    ...
                    $url = $request->obj()->server->get('HTTP_ORIGIN'). urlRoute('/system/password/form/load/'.$jwt);
